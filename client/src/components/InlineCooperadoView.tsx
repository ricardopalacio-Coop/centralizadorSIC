...
export const InlineCooperadoView: React.FC<InlineCooperadoViewProps> = ({
  ...
  // Filtrar os registros de produtividade pela data selecionada de forma 100% dinâmica
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden animate-in fade-in duration-300">
      ...
      <div className="p-6 border-b border-slate-200 bg-slate-50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        {/* Badge Resumida do Último Acesso Mobile */}
        {appData && (
          <div className="flex flex-col items-end space-y-1">
            <div className="flex items-center space-x-2 px-3.5 py-1.5 rounded-2xl bg-sky-50 border border-sky-200 text-xs text-sky-800 font-bold">
              ...
              <span>Último Acesso Mobile: <strong>{appData.lastAccess?.date ? formatDateTime(appData.lastAccess.date) : "Sem registro"}</strong></span>
            </div>
